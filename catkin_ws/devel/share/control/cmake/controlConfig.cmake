...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /fs03/share/users/florent.cadot/home/Bureau/Proto/catkin_ws/src/control)
  set(control_DEVEL_PREFIX /fs03/share/users/florent.cadot/home/Bureau/Proto/catkin_ws/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /fs03/share/users/florent.cadot/home/Bureau/Proto/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'florent.cadot <florent.cadot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/fs03/share/users/florent.cadot/home/Bureau/Proto/catkin_ws/src/control/${idir}'.  Ask the maintainer 'florent.cadot <florent.cadot@todo.todo>' to fix it.")
    endif()
